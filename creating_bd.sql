...
CREATE TABLE jobs (post_id INTEGER NOT NULL PRIMARY KEY AUTOINCREMENT, name TEXT NOT NULL);
CREATE TABLE film_person (person_id INTEGER NOT NULL, film_id INTEGER NOT NULL, post_id INTEGER NOT NULL, PRIMARY KEY (person_id, film_id, post_id), FOREIGN KEY (person_id) REFERENCES person(person_id), FOREIGN KEY (film_id) REFERENCES film(film_id), FOREIGN KEY (post_id) REFERENCES jobs(post_id));
...
INSERT INTO jobs VALUES (NULL, "актер"), (NULL, "режиссер"), (NULL, "сценарист");

INSERT INTO film_person VALUES (4, 1, 1), (3, 1, 1), (2, 1, 1), (1, 1, 1), (10, 2, 1), (11, 2, 1), (12, 3, 1), (14, 3, 1),
(6, 1, 3), (7, 1, 3), (9, 2, 3), (13, 3, 3), (5, 1, 2), (8, 2, 2), (12, 3, 2);

INSERT INTO film_country VALUES (1, 2), (1, 3), (3, 2), (2, 4), (2, 3), (3, 3), (3, 5);
